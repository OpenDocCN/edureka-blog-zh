...
> 原文：[Edureka Blog](https://www.edureka.co/blog/)
> 
...
*   在我们的 [apachecn/edureka-blog-zh](https://github.com/apachecn/edureka-blog-zh) github 上提 issue.
...
```
docker pull apachecn0/edureka-blog-zh
docker run -tid -p <port>:80 apachecn0/edureka-blog-zh
...
```
pip install edureka-blog-zh
edureka-blog-zh <port>
# 访问 http://localhost:{port} 查看文档
```
